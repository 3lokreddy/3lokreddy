"""
eth_bot.py  —  Ethereum (ETH/USDT) Trading Analysis Bot
─────────────────────────────────────────────────────────────────────────────
...
Usage:
  python eth_bot.py
  python eth_bot.py --account 50000 --risk 2
"""
...
# ── Bot configuration ─────────────────────────────────────────────────────────
SYMBOL       = "ETHUSDT"
DISPLAY_NAME = "ETH/USDT  (Ethereum)"
...
def run_eth_bot(account_size: float = ACCOUNT_SIZE, risk_pct: float = RISK_PCT) -> None:
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="ETH/USDT Trading Analysis Bot — instant multi-timeframe recommendations"
    )
    p.add_argument(
